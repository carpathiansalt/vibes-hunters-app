            ...
            <div className="mb-4 mt-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2 mb-4">
                    <button
                        ...
                        className={`flex-1 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeSource === 'file' ? 'bg-purple-600 text-white shadow-md' : 'bg-white border border-gray-300 text-gray-700 hover:bg-gray-50'}`}
                    >
                        📁 Upload File
                    </button>
                    <button
                        onClick={() => setActiveSource('tab-capture')}
                        className={`flex-1 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeSource === 'tab-capture' ? 'bg-purple-600 text-white shadow-md' : isMobile ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white border border-gray-300 text-gray-700 hover:bg-gray-50'}`}
                        disabled={isMobile}
                    >
                            ...
                            {isLoading ? (
                                <span className="flex items-center justify-center">
                                    <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-purple-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        ...
                                        <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 2 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
